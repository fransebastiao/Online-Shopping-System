...
class  UserRoleControllerTest {
    ...
    void setUp() {
        ...
        this.userRole = UserRoleFactory.createUserRole("323809-1342891","User");
        this.baseUrl = "http://localhost:" + this.port + "/online-shopping-system/user-role/";
    }
    ...
    @Test
    void delete() {
        String url = baseUrl + "delete/" + this.userRole.getRoleId();
        System.out.println(url);
    ...
    @Test
    void readId() {
        String url = baseUrl + "read/" + this.userRole.getRoleId();
        System.out.println(url);
        ResponseEntity<UserRole> response = this.restTemplate
                .withBasicAuth("admin-user", "65ff7492d30")
